...
namespace QuantumMaster.Features.Actions
{
    ...
    public class ScamPatch
    {
        ...
        {
            if (!ConfigManager.scam) return true;

            return ActionPatchHelper.HandleActionPhase(random, targetChar, alertFactor, showCheckAnim, 0, ref __result, __instance);
        }
    }
}
