...
气运之子：做任何事情都必然一定成功，获取的随机收益都是理论上限（概率为0的情况下无效）]],
        ...
        },
        {
            ...
            Key = "steal",
            DisplayName = "【气运】偷窃",
            Description = "【气运】偷窃成功概率根据设置的气运增加或者减少",
            DefaultValue = true,
        },
        {
            SettingType = "Toggle",
            Key = "scam",
            DisplayName = "【气运】唬骗",
            Description = "【气运】唬骗成功概率根据设置的气运增加或者减少",
            DefaultValue = true,
        },
        {
            SettingType = "Toggle",
            Key = "rob",
            DisplayName = "【气运】抢劫",
            Description = "【气运】抢劫成功概率根据设置的气运增加或者减少",
            DefaultValue = true,
        },
        {
            SettingType = "Toggle",
            ...
            Description = "【气运】偷学生活技能成功概率根据设置的气运增加或者减少",
            DefaultValue = true,
        },
        {
            SettingType = "Toggle",
            ...
            Description = "【气运】偷学战斗技能成功概率根据设置的气运增加或者减少",
            DefaultValue = true,
        },
        {
            SettingType = "Toggle",
            Key = "poison",
            DisplayName = "【气运】下毒",
            Description = "【气运】下毒成功概率根据设置的气运增加或者减少",
            DefaultValue = true,
        },
        {
            SettingType = "Toggle",
            Key = "plotHarm",
            DisplayName = "【气运】暗害",
            Description = "【气运】暗害成功概率根据设置的气运增加或者减少",
            DefaultValue = true,
        },
        {
            SettingType = "Dropdown",
